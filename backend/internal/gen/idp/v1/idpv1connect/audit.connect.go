...
const (
	...
	AuditServiceName = "idp.v1.AuditService"
)
...
const (
	...
	// ListAuditLogs RPC.
	AuditServiceListAuditLogsProcedure = "/idp.v1.AuditService/ListAuditLogs"
)

// AuditServiceClient is a client for the idp.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the idp.v1.AuditService service. By default, it
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_idp_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAuditLogs calls idp.v1.AuditService.ListAuditLogs.
...
// AuditServiceHandler is an implementation of the idp.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/idp.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditLogs(context.Context, *connect.Request[v1.ListAuditLogsRequest]) (*connect.Response[v1.ListAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.AuditService.ListAuditLogs is not implemented"))
}
