...
const (
	...
	HealthServiceName = "idp.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/idp.v1.HealthService/Check"
)

// HealthServiceClient is a client for the idp.v1.HealthService service.
type HealthServiceClient interface {
	// Check returns the current health status of the platform.
	Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error)
}

// NewHealthServiceClient constructs a client for the idp.v1.HealthService service. By default, it
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_idp_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls idp.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the idp.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/idp.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.HealthService.Check is not implemented"))
}
