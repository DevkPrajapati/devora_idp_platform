...
const (
	...
	ProjectServiceName = "idp.v1.ProjectService"
)
...
// NewProjectServiceClient constructs a client for the idp.v1.ProjectService service. By default, it
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_idp_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// CreateProject calls idp.v1.ProjectService.CreateProject.
...
// GetProject calls idp.v1.ProjectService.GetProject.
...
// ListProjects calls idp.v1.ProjectService.ListProjects.
...
// UpdateProject calls idp.v1.ProjectService.UpdateProject.
...
// DeleteProject calls idp.v1.ProjectService.DeleteProject.
...
// AddMember calls idp.v1.ProjectService.AddMember.
func (c *projectServiceClient) AddMember(ctx context.Context, req *connect.Request[v1.AddMemberRequest]) (*connect.Response[v1.AddMemberResponse], error) {
	return c.addMember.CallUnary(ctx, req)
}

// RemoveMember calls idp.v1.ProjectService.RemoveMember.
...
// ListMembers calls idp.v1.ProjectService.ListMembers.
...
// ProjectServiceHandler is an implementation of the idp.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	projectServiceAddMemberHandler := connect.NewUnaryHandler(
	...
	return "/idp.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.CreateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) UpdateProject(context.Context, *connect.Request[v1.UpdateProjectRequest]) (*connect.Response[v1.UpdateProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.UpdateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) DeleteProject(context.Context, *connect.Request[v1.DeleteProjectRequest]) (*connect.Response[v1.DeleteProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.DeleteProject is not implemented"))
}

func (UnimplementedProjectServiceHandler) AddMember(context.Context, *connect.Request[v1.AddMemberRequest]) (*connect.Response[v1.AddMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.AddMember is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) RemoveMember(context.Context, *connect.Request[v1.RemoveMemberRequest]) (*connect.Response[v1.RemoveMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.RemoveMember is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListMembers(context.Context, *connect.Request[v1.ListMembersRequest]) (*connect.Response[v1.ListMembersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.v1.ProjectService.ListMembers is not implemented"))
}
